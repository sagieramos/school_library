...
**[school_library]** add Person, Student and Teacher classes
...
``` sh
    git clone https://github.com/sagieramos/school_library
```
...
Feel free to check the [issues page](https://github.com/sagieramos/school_library/issues).
